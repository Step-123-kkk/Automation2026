...
test('Excel data based automation', async ({ page }) => {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    try {
            ...
            fileInput.setInputFiles('C:/Users/divya/Downloads/WARRNTY_SHEE001_12_17_2025_713.pdf');
            await page.locator("div[class='col-sm-6 ng-star-inserted'] td[class='ng-star-inserted']").click();
            // import path from 'path';
            // const filePath = path.resolve(__dirname, '../test-data/WARRNTY_SHEE001_12_17_2025_713.pdf');
